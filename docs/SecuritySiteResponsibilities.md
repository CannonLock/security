...
Don't hesitate to tell us how we can be more effective or to ask a question. You can email <security@opensciencegrid.org> or contact one of the security [team members](https://osg-htc.org/security/#team-members) individually.
...
### 8. [Maintain up-to-date Trusted CA/CRL information](https://osg-htc.org/docs/common/ca/)
